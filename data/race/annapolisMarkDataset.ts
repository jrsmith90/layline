...
// Supplemental harbor and Severn references used in the custom course plotter.
export const ANNAPOLIS_SUPPLEMENTAL_PLOTTER_MARKS: Record<string, RaceCourseMarkRecord> = {
  A_NAVAL: {
    id: "A",
    shortName: "A",
    labelHint: "Naval",
    name: "Naval Anchorage Light A",
  ...
  SC: {
    id: "SC",
    shortName: "SC",
    name: "Severn Channel Lighted Buoy SC",
  ...
  R2: {
    id: "R2",
    shortName: "R2",
    name: "Annapolis Harbor Channel Buoy 2",
    markType: "government_buoy",
    markColor: "red",
    lat: 38.94181,
    lon: -76.42611,
  ...
  R4: {
    id: "R4",
    shortName: "R4",
    name: "Annapolis Harbor Channel Buoy 4",
    markType: "government_buoy",
    markColor: "red",
    lat: 38.96806,
    lon: -76.45861,
  ...
  G5: {
    id: "G5",
    shortName: "G5",
    name: "Annapolis Harbor Channel Buoy 5",
    markType: "government_buoy",
    markColor: "green",
    lat: 38.97167,
    lon: -76.46194,
  ...
  R6: {
    id: "R6",
    shortName: "R6",
    name: "Annapolis Harbor Channel Buoy 6",
    markType: "government_buoy",
    markColor: "red",
    lat: 38.97472,
    lon: -76.46306,
  ...
  R8: {
    id: "R8",
    shortName: "R8",
    name: "Annapolis Harbor Channel Buoy 8",
    markType: "government_buoy",
    markColor: "red",
    lat: 38.97744,
    lon: -76.46583,
  ...
  G9: {
    id: "G9",
    shortName: "G9",
    name: "Annapolis Harbor Channel Buoy 9",
    markType: "government_buoy",
    markColor: "green",
    lat: 38.97833,
    lon: -76.46694,
  ...
  G13: {
    id: "G13",
    shortName: "G13",
    name: "Annapolis Harbor Channel Buoy 13",
    markType: "government_buoy",
    markColor: "green",
    lat: 38.98417,
    lon: -76.47611,
