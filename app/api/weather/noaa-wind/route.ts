...
async function getCbibsAnnapolisSnapshot(): Promise<CbibsAnnapolisSnapshot | undefined> {
  ...
  return {
    ...
    locationName: "Mouth of the Severn River off Annapolis",
...
async function getThomasPointSnapshot(): Promise<NdbcThomasPointSnapshot | undefined> {
  ...
  return {
    ...
    locationName: "Thomas Point Light, open Chesapeake Bay reference",
    stationUse: "Bay-facing wind reference; better for open Bay racing than the Naval Academy station.",
